...
%% DESCRIPTION
% evalute the derivative of the modeled psychometric function with respect
% to six system parameters
%% INPUT 
% A             stimulus amplitude [mA]
% PW            pulse width [ms]
% alpha1        peripherial threshold [mA]
% tau1          time constant of free nerve endings [ms]
% tau2          time constant of dorsal horn neurons [ms]
% alphaL        activation threshold of dorsal horn neurons [A/s]
% sigmaL        slope parameter for the activation of dorsal horn neurons [A/s]
% lambdaL       fire frequency of the dorsal horn neurons
% taus          time constant for post-synapse current via AMPA receptors
% Mmatrix       
% PSPnopsum     
% eralphaL      
% exptsum
%% OUTPUT   
% Pr            psychometric function value
% Jx            Jacobian matrix
