function [current_pm,current_pp,current_PLm,current_PLp] = Data2PL_20160326(Data,paramH_index,optimized_p,lball,uball,fileSRP,PLk,minchi2)
%% DESCRIPTION
%% INPUT
...
parfor parami = paramH_index
    ...
    while flag_c
        ...
        [current_osub] = PL2est1(Data,parami,paramf,seed,stepi-1,flag_s,current_pp{parami}(stepi-1,:),fileSRP,lball,uball,PLk,minchi2,flag_store);
...
%         [current_osub] = checkpsub(parami,stepi-1,flag_s,fileSRP,PLk);
    ...
    while flag_c
        ...
        %  now fix paramf at parami, and re-optimized the other parameters
        seed = 20142015;
        current_osub = PL2est1(Data,parami,paramf,seed,stepi-1,flag_s,current_pm{parami}(stepi-1,:),fileSRP,lball,uball,PLk,minchi2,flag_store);
        %         check the PL at this point
%         [current_osub] = checkpsub(parami,stepi-1,flag_s,fileSRP,PLk);
        % update the sub-parameters
